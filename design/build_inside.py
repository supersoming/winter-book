...
# ================= 3. 주간 Δ =================
def weekly():
    cols = ['#DABDFF','#CDC6FF','#BFCBFF','#B5E6F7','#BEEBE3','#C6F0D6','#E6F2C6','#FFF1B5','#FFCFB0','#FFB5C2']
    rows = ''
    for i in range(10):
  ...
  <div style="display: flex; flex-direction: column; gap: 12px; padding-top: 24px;">
    ...
    <div style="display: grid; grid-template-columns: repeat(2, minmax(0, 1fr)); gap: 0; border-top: 1px solid #443E5C; border-bottom: 1px solid #443E5C;">
      ...
      <div style="padding: 12px 0 12px 14px; display: flex; flex-direction: column; gap: 8px;">
        ...
        <div style="height: 21px; border-bottom: 1px dashed #F2C9D3;"></div><div style="height: 21px; border-bottom: 1px dashed #F2C9D3;"></div><div style="height: 21px; border-bottom: 1px dashed #F2C9D3;"></div>
      </div>
    </div>
  </div>
  ...
  <div style="display: flex; gap: 26px; flex-grow: 1; padding-top: 22px;">
    <div style="display: flex; flex-direction: column; gap: 18px; flex-grow: 1; min-width: 0;">
      ...
      <div style="display: flex; flex-direction: column; gap: 12px; border: 3px solid transparent; background: linear-gradient(#fff, #fff) padding-box, {a["g"]} border-box; padding: 16px 20px;">
        ...
        <div style="display: flex; flex-direction: column; gap: 8px; padding-top: 10px; border-top: 1px dashed #F2C9D3;">
